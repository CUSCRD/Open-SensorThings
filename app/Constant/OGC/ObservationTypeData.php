...
class ObservationTypeData extends BaseFixedData
{
    ...
    const FACE_OBSERVATION = array(
        'code' => 'OM_FaceObservation',
        'codeValue' => 'http://www.opengis.net/def/observationType/OGC-OM/2.0/OM_FaceObservation',
        'result' => 'Any'
    );
    const COMPLEX_COUNTING_OBSERVATION = array(
        'code' => 'OM_ComplexCountingObservation',
        'codeValue' => 'http://www.opengis.net/def/observationType/OGC-OM/2.0/OM_ComplexCountingObservation',
        'result' => 'Any'
    );
}
